...
interface Notification {
  ...
  title: string;
  message: string;
  type: 'payment' | 'refund' | 'report' | 'general';
  read: boolean;
  time: string;
  date: string;
}
...
export default function CashierNotificationsPage() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      message: 'Your daily sales report for December 6, 2025 is ready to view.',
      type: 'report',
      read: false,
      time: '2 hours ago',
      date: '2025-12-07',
    },
    {
      ...
      message: 'Refund request for booking #1234 requires your attention.',
      type: 'refund',
      read: true,
      time: '3 hours ago',
      date: '2025-12-07',
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-4xl font-bold text-gray-900">Cashier Notifications</h1>
        </div>
