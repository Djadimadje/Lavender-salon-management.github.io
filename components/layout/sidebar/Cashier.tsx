...
export default function CashierSidebar({ userEmail, userName, userImage }: CashierSidebarProps) {
  ...
  const initials = getInitials(userEmail || 'cashier@lavender.com');
