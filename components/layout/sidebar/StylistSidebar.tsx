...
import { stylistNavItems } from '@/lib/routes';
...
export default function StylistSidebar({ userEmail, userName, userImage }: StylistSidebarProps) {
  ...
  const initials = getInitials(userEmail || 'stylist@lavender.com');

  // Mock notifications for stylist
  const notifications = [
    { id: 1, message: 'New booking: Hair Styling at 2:00 PM', read: false, time: '20 min ago' },
    { id: 2, message: 'Customer rated you 5 stars!', read: false, time: '1 hour ago' },
    { id: 3, message: 'Reminder: Appointment in 30 minutes', read: false, time: '2 hours ago' },
    { id: 4, message: 'Schedule updated for tomorrow', read: true, time: '5 hours ago' },
  ];
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="font-semibold text-white">
              {userName || 'Stylist Portal'}
            </p>
            <p className="text-xs text-white/60">
              {userEmail || 'stylist@lavender.com'}
            </p>
          </div>
          {/* Notification Bell */}
            ...
            {showNotifications && (
              <div className="fixed left-72 top-20 w-80 bg-white rounded-lg shadow-2xl z-[9999] max-h-96 overflow-y-auto border border-gray-200">
                ...
                <div className="p-3 border-t border-gray-200 text-center space-y-2">
                  ...
                  <Link
                    href="/dashboard/stylist/notifications"
