...
export default function CustomerSidebar({ userEmail }: CustomerSidebarProps) {
  ...
  const notifications = [
    { id: 1, message: 'Your appointment is confirmed for Dec 10, 2025', read: false, time: '2 hours ago' },
    { id: 2, message: 'Reminder: Appointment tomorrow at 10:00 AM', read: false, time: '1 day ago' },
    { id: 3, message: 'Your booking has been confirmed', read: true, time: '3 days ago' },
  ];
